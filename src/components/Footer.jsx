        ...
        <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="heading">
                    ...
                    <h1 className="text-[7vw] font-semibold uppercase leading-none -mb-8">
                        OPENING
                    </h1>
                </div>
            ...
            <div className="w-1/2">
                <div className="heading">
                    <h1 className="text-[5vw] px-14 pt-5 font-medium uppercase leading-none -mb-5">
                        PRESENTATIONS
                    </h1>
                    <div className="ref mt-10 px-5 flex  flex-col items-center">
                        ...
                        <h1 className=' mb-6 pt-8 text-xl'>Email:</h1>
                        ...
                        <div className="br flex gap-10 px-16">
                            ...
                            <div className="pt">
                                <h2 className='block text-lg font-light underline'>30 Chukarina St
                                    Lviv, Ukraine</h2>
                            </div>
                        </div>
                    </div>
